...
exports.globalEncryption = exports.globalDecryption = void 0;
...
const globalDecryption = (req, res, next) => {
    ...
    if (req.method === 'POST' || req.method === 'PUT' || req.method === 'PATCH') {
        ...
        try {
            const decrypted = (0, encryption_1.decryptPayload)(req.body.data);
            if (decrypted) {
...
const globalEncryption = (req, res, next) => {
    ...
    res.json = function (data) {
        ...
        try {
            const encrypted = (0, encryption_1.encryptResponse)(data);
